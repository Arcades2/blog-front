...
function AnimatedBackground() {
  ...
  return (
    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -z-10 animated-background">
      <MorphReplace width={600} height={600} rotation="none">
        {icons[currentIcon]}
      </MorphReplace>
    </div>
  );
